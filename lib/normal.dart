...
class _normalState extends State<normal> {
  ...
  drowPolyLine() async {
    var url = Uri.parse(
        'http://router.project-osrm.org/route/v1/driving/${myLocatonfirst.longitude},${myLocatonfirst.latitude};${destination.longitude},${destination.latitude}?steps=true&annotations=true&geometries=geojson&overview=full');
            ...
            children: [
              ...
              MarkerLayer(
                markers: [
                  ...
                  Marker(
                      point: LatLng(31.235461499170974, 30.029223370719002),
                      width: 150,
                      height: 150,
                      alignment: Alignment.center,
                      child: Column(
                  ...
                  Marker(
                      point: LatLng(31.23822117050530, 30.036543395333496),
                      width: 150,
                      height: 150,
                      alignment: Alignment.center,
                      child: Column(
                  ...
                  //
                  Marker(
                      point: LatLng(31.233902457803996, 30.034932994411193),
                      width: 150,
                      height: 150,
                      alignment: Alignment.center,
                      child: Column(
                  ...
                  Marker(
                      point: LatLng(31.233162415669277, 30.032489289179807),
                      width: 150,
                      height: 150,
                      alignment: Alignment.center,
                      child: Column(
                  ...
                  Marker(
                      point: LatLng(31.236826449571545, 30.032124403259715),
                      width: 150,
                      height: 150,
                      alignment: Alignment.center,
                      child: Column(
                  ...
                  Marker(
                      point: LatLng(31.234745891562866, 30.236884704991596),
                      width: 150,
                      height: 150,
                      alignment: Alignment.center,
                      child: Column(
                  ...
                  Marker(
                      point: LatLng(31.23266031597589, 30.235546657192405),
                      width: 150,
                      height: 150,
                      alignment: Alignment.center,
                      child: Column(
                  ...
                  Marker(
                      point: LatLng(31.232669128863687, 30.030751240155272),
                      width: 150,
                      height: 150,
                      alignment: Alignment.center,
                      child: Column(
                        children: [
                          Text('شارع بستان الفاضل'),
                          InkWell(
                            onTap: () {
                              showModalBottomSheet(
                                context: context,
